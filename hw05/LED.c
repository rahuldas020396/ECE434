...
static unsigned int gpioLED = 51;       ///< hard coding the LED gpio for this example to P9_16 (GPIO49)
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,   // Interrupt on rising or falling edge (button press, not release)
